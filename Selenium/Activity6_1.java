...
public class Activity6_1 {
    ...
    public static void main(String[] args) {
        ...
        List<WebElement> rows=driver.findElements(By.xpath("//table[@class='striped table']/tbody/tr"));
        List<WebElement> cols=driver.findElements(By.xpath("//table[@class='striped table']/tbody/tr[1]/td"));
