...
public class googleChromeActivity3 {
  ...
  public void popUps(String username, String password) {
      ...
      wait.until(ExpectedConditions.visibilityOfElementLocated(MobileBy.xpath("//android.webkit.WebView/android.view.View[1]/android.view.View[2]")));
