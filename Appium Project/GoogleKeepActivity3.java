  ...
  public void addTaskToGoogleKeep() {
	  driver.manage().timeouts().implicitlyWait(10, TimeUnit.SECONDS);
		...
		//Wait for the New Task label to appear
	      ...
	      //wait for reminder icon to be clickable
	      ...
	      //wait for the date options to open
	      wait.until(ExpectedConditions.invisibilityOfElementWithText(MobileBy.id("com.google.android.keep:id/save"), "save"));
	      
	      //Click on Today
	      driver.findElementById("com.google.android.keep:id/text").click();
	      
	    //wait for the date list to appear
	      wait.until(ExpectedConditions.textToBePresentInElementLocated(MobileBy.id("dialog_title"), "Add reminder"));
	        
	    //click on save
	      driver.findElementById("com.google.android.keep:id/save").click();
	      
	      //wait till the reminder is added
	      ...
	      driver.findElementById("reminder_chip_text").isDisplayed();      
